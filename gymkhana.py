...
green_nd_bold = '\033[92m' + bold               #for printing titles
blue_nd_bold = '\033[94m' + '\033[4m' + bold    #for printing author
yellow_nd_bold = '\033[93m' + '\033[4m' + bold  #for printing final result
pink_nd_bold = '\033[94m' + bold                #for printing results
...
uclm_url2 =  "http://atclab.esi.uclm.es:5000/"
my_UDPserver_port = 44444
my_TCPserver_port = 55555

#METHODS----------------------------------------------------------------------------------
def step0():
    print(green_nd_bold + "----------------------PYTHON GYMKHANA------------------------------------------------\n" + end_format)
    print(blue_nd_bold + "Pedroma, 2ºA\n" + end_format)
...
def step1(server_code):
    print(green_nd_bold + "----------------------STEP 1: UDP THREADING SERVER-----------------------------------\n" + end_format)
